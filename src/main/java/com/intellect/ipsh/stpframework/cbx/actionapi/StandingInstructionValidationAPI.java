 ...
 *
 * File Name           :	StandingInstructionValidationAPI.java
 *
 * Description         :	************************
 *
...
public class StandingInstructionValidationAPI {

	public String processStandingInstructionRequest(String jsonInString) {
